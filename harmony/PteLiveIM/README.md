# PteLiveIM HarmonyOS Native SDK

`@ptelive/im` is an independent ArkTS SDK for HarmonyOS. It is not part of the uni-app x UTS plugin.
...
const client = await PteLiveIM.configure(this.context, base).login(
