...
/**
 * Demo application navigation chrome.
 *
 ...
 * icon contrast. It belongs to the demo application's login/register flow,
 * not to the reusable IM UI kit.
 */
open class PteIMUIDemoNavigationBar(
  context: Context,
  ...
  init {
    ...
    backButton.apply {
      ...
      setPadding(0, 0, 0, 0)
      setImageResource(R.drawable.pte_im_ui_demo_back)
  ...
  companion object {
    ...
    /** Convenience for demo Activity hosts that use the default UI-kit palette. */
